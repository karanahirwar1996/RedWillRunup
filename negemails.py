def neg_email(sorted_df,concat_df):
    import pandas as pd
    import smtplib
  ...
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/gsapi300423%40original-advice-385307.iam.gserviceaccount.com"
    ...
    for recipient in receiver_email:
        msg = MIMEMultipart()
        msg["Subject"] = f"✨ Daily Negative News Digest- {current_date} ({positive_news_count} out of {len(concat_df)} articles with a positive perspective)✨"
